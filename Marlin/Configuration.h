...
#define STRING_CONFIG_H_AUTHOR "(BigBell)" // Who made the changes.
 ...
 */
#define X_MIN_ENDSTOP_HIT_STATE true
#define X_MAX_ENDSTOP_HIT_STATE true
#define Y_MIN_ENDSTOP_HIT_STATE true
#define Y_MAX_ENDSTOP_HIT_STATE HIGH
#define Z_MIN_ENDSTOP_HIT_STATE true
...
//
//#define CR10_STOCKDISPLAY //подключить дисплей
